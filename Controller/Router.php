...
class Router implements \Magento\Framework\App\RouterInterface
{
                    ...
                    if ( !$cat->getId() || !$cat->getData('is_activ') ) {
                        ...
                        if ( $countParts === 2 ) {
                            ...
                            if ( strpos($identifier[2] , $prefix) !== false ) {
                                ...
                                $news->getSelect()->joinLeft([ 'second' => 'cms_categories_news' ] ,
                                ...
                                if ( $news ) {
                                    ...
                                    $request->setModuleName('news')->setControllerName('view')->setActionName('index');
    ...
    {
        $this->_response->setRedirect("/{$this->config->getUrlNews()}");
